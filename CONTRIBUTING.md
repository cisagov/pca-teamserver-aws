...
issue](https://github.com/cisagov/pca-teamserver-aws/issues) in this
...
request](https://github.com/cisagov/pca-teamserver-aws/pulls), you
...
```console
cd pca-teamserver-aws
pyenv virtualenv <python_version_to_use> pca-teamserver-aws
pyenv local pca-teamserver-aws
