locals {
  # The ports on which traffic is allowed to ingress
  ingress_ports = [
    22,
    50050
  ]
...
# Allow ingress from anywhere via ssh and the Cobalt Strike port
# (50050).  The security group rules will refine access further to
# specific, trusted CIDR blocks.
